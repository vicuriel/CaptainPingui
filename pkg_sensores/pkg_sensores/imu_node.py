...
class ImuNode(Node):
    def __init__(self):
        ...
        self.serial_port = '/dev/ttyUSB0'   # Cambiar si hace falta
        self.baudrate = 9600                # Debe coincidir con el ESP32/Arduino
        ...
        self.get_logger().info('imu_node iniciado correctamente')

    def read_serial(self):
        """Lee las líneas que llegan desde el microcontrolador por serial."""
        if self.ser is None:
            return
    ...
    def publish_imu(self):
        """Publica los datos de la IMU en /imu/data."""
        ...
        # Convertir aceleración de g a m/s^2
        ax = ax_g * 9.80665
        ay = ay_g * 9.80665
        az = az_g * 9.80665
        ...
        # Orientación no disponible todavía
    ...
    def print_data(self):
        """Imprime en consola los últimos datos recibidos cada 1 segundo."""
        if self.accel_data is None or self.gyro_data is None:
            return
